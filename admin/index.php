...
<div class="container-fluid vh-100 bg">
    <div class="row">
        <div class="col-md-12 py-5 text-center text-white main-login-page">
            <h1>Signin to continue &nbsp;<i class="zmdi zmdi-arrow-forward"></i></h1>
        </div>
    </div>
    <div class="row">
            ...
            <div class="form-wrap-1">
                ...
                <div class="wavefire-form shadow">
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-5">
                                <input type="submit" name="login" id="login" value="Login" class="btn btn-block bg-light font-weight-bold">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                if(isset($_POST['login'])){
                                    ...
                                    if(mysqli_num_rows($l_result)>0){
                                            ...
                                            echo"<p class='text-danger text-light'>Wrong Credentials</p>";
                                            }
                                    }
                                    ?>
                                </div>
